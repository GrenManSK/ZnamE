        ...
        if anime_vstup == "1":
                    ...
                    for i in os.listdir("anime_search"):
                        if (name := i.split("."))[1] == "png":
                            ...
                            if name[0] == "anime":
                                ...
                                os.rename(f"anime_search/{i}", "anime_search/anime.png")
                                koniec: bool = True
                        if (name := i.split("."))[1] in [
                            "jpg",
                            "jpeg",
                            "jpe",
                            "jif",
            ...
            try:
                anime = requests.post(
                    ...
                    data=open("anime_search/anime.png", "rb"),
                ...
                if anime_vstup_success == "1":
                    ...
                    if anime_vstup_video in ["", "y"]:
                        ...
                        try:
                            ...
                            pass
                        typewriter("Copying video to download folder", end="\r")
                        shutil.copy(
                            "anime_search/anime_video.mp4",
                            "download/anime_video-" + imagetime + ".mp4",
                        )
                        typewriter("Done                                            ")
                    ...
                    if anime_vstup_image in ["", "y"]:
                        ...
                        typewriter("Copying video to download folder", end="\r")
                        shutil.copy(
                            "anime_search/anime_image.png",
                            "download/anime_image-" + imagetime + ".png",
                        )
                        typewriter("Done                                            ")
            ...
            try:
                anime = requests.get(
                    "https://api.trace.moe/search?url={}".format(
                        urllib.parse.quote_plus(input("Paste here image url>"))
                    )
                ).json()
            except FileNotFoundError:
                continue
